...
rowTotal = result.sum(axis = 0)
columnTotal = result.sum(axis = 1)
# print(rowTotal)
# print(columnTotal)
...
# print('matrisin en büyük değerinin indeksi:',result.argmax())
...
matris = np.arange(10,20).reshape(2,5)
# print(matris[0])
